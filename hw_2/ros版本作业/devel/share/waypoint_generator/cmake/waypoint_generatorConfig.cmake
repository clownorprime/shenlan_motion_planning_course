...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_generator_SOURCE_PREFIX /root/shenlan/18_motion_planning/hw_2/ros版本作业/src/waypoint_generator)
  set(waypoint_generator_DEVEL_PREFIX /root/shenlan/18_motion_planning/hw_2/ros版本作业/devel)
  ...
  set(waypoint_generator_INSTALL_PREFIX /root/shenlan/18_motion_planning/hw_2/ros版本作业/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_generator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/shenlan/18_motion_planning/hw_2/ros版本作业/src/waypoint_generator/${idir}'.  ${_report}")
    endif()
